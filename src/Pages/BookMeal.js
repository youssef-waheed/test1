...
function FileUpload() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/applications/bookMealExcel', formData, {
        headers: {
      ...
      <div className="two-column-wrapper">
        <div className="col">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="dateOfReceivingMeals">تاريخ حجز الوجبة:</label>
        ...
        <div className='coll'> 
          <p>يجب التاكد من تاريخ حجز الوجبات</p>
          <p>يجب اختيار الوجبة الجاري حجزها</p>
