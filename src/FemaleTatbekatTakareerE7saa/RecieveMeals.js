  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/applications/receiveMealExcel",
        formData,
        {
          headers: {
    ...
    <div>
      <div className="two-column-wrapper">
        ...
        <div className="coll">
          ...
          <p>
            يجب ان يحتوي الملف علي الارقام القومية لالطالبات في اول عمود في اول
            صفحة من الملف
          </p>
          <p>
            {" "}
            بعد رفع الملف يتم الضغط علي زر Upload ثم يظهر تقرير بعدد الطالبات
            المستحقات للوجبة و قد تم تسجيل استلامهم للوجبة و يظهر تقرير بالاخطاء
          </p>
