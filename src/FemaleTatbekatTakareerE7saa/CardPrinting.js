...
import frontCardImage from '../Pages/1.png';
import '../Pages/PrintCard.css';
...
const PrintCard = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://localhost:5000/applications/unprintedCardsForFemales');
  ...
  return (
    <div className="two-column-wrapper">
      ...
      <div className="coll">
        <ul>
          <li>الاسماء المعروضة هي الطالبات الساكنين و لهم صور و لم يتم طباعة بطاقتهم</li>
